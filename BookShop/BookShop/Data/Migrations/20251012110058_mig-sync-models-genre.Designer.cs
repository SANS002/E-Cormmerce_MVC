...
namespace BookShop.Data.Migrations
{
    ...
    [Migration("20251012110058_mig-sync-models-genre")]
    partial class migsyncmodelsgenre
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookShop.Models.ShoppingCart", b =>
                {
                    ...
                    b.ToTable("ShopiingCart");
                });

            modelBuilder.Entity("BookShop.Models.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShop.Models.Stock", b =>
                {
                    b.HasOne("BookShop.Models.Book", "Book")
                        .WithOne("Stock")
                        .HasForeignKey("BookShop.Models.Stock", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
